...
wait = {
    ...
    "lang":"JP",
    "comment":"Auto Like By : Alin Ghost Rider",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#                            Name = summon(op.param2)
        ...
        if op.type == 15:
            if op.param2 in admin:
                return
            cl.sendText(op.param1, "Tukan tukan dikit2 baper \n Moga tenang diluar sana")
            print "MEMBER HAS LEFT THE GROUP" 
        if op.type == 19:
            if mid in op.param3:
...
#---------------------------------------------------------
                ...
                cl.sendText(msg.to,"Send kontak")
#---------------------------------------------------------          
...
#---------------------------------------------------------
             ...
             if msg.from_ in admin:
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Protect Already on")
                    else:
                        cl.sendText(msg.to,"Protect Already on")
                        ki.sendText(msg.to,"Protect Already on")
                else:
             ...
             if msg.from_ in admin:
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Link Already on")
                        ki.sendText(msg.to,"Link Already on")
                    else:
                        cl.sendText(msg.to,"Link Already on")
                        ki.sendText(msg.to,"Link Already on")
                else:
             ...
             if msg.from_ in admin:
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Invite Already on")
                        ki.sendText(msg.to,"Invite Already on")
                    else:
                        cl.sendText(msg.to,"Invite Already on")
                        ki.sendText(msg.to,"Invite Already on")
                else:
             ...
             if msg.from_ in admin:
                if wait["cancelprotect"] == True:
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Cancel Already on ")
                    else:
                        cl.sendText(msg.to,"Cancel Already on")
                        ki.sendText(msg.to,"Cancel Already on ")
                else:
                ...
                if wait["autoJoin"] == True:
                    ...
                    wait["autoJoin"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"AutojoinAlready on")
                    else:
                        cl.sendText(msg.to,"Autojoin Already on")
...
#---------------------------------------------------------
      ...
      #---------------------------------------------------------          
                ...
                if msg.to in cctv['point']:
                    ...
                    cl.sendText(msg.to, "On aja belom 😇")            
