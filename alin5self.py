...
#cl.login(qr=True)
cl.login(token="EqHUAEbqMCn7yqJVdK97.X5Bf98jvJqs+mT+eSHtRHW.79KHFGm47S1heS8QSGRz5JUbf4+90N8d2VDGHNCj0/s=")
cl.loginResult()
...
#ki2.login(qr=True)
ki2.login(token="EqieaStSBkqTllHbeDQb.FCvRR/tACAdmpj9ZglA/EW.HrZbrxPVt6qXMv+DAPL4tUndfi3bP2kics5ga1xiIBY=")
ki2.loginResult()

ki3 = LINETCR.LINE() #bot3
#ki3.login(qr=True)
ki3.login(token="Eq8uhSbZQkJ2U3GSqKk0.daTBxtjIT2ByORYwthVYaa.1t+Z3SbunrEAzOQX7oWkKkjw5HzWI8NFiiRE9fi4EKk=")
ki3.loginResult()

ki4 = LINETCR.LINE() #bot4
#ki4.login(qr=True)
ki4.login(token="ErfTmlWiq2agMp92ZRg4.tIjVi8efVS0frzXQKuLwXa.Ob5RGZkKo3a8q4rnl+VggtxED/sqgXCCPpoK0Tt0z0c=")
ki4.loginResult()

ki5 = LINETCR.LINE() #bot5
#ki5.login(qr=True)
ki5.login(token="Ert2Ueg6ck2p54rlZxX0.FQhmA8IJ2FoyrpOtVeLkia.rVDD6J3F9ruZXXpLG90sSLkRas8Pb3lESaSQ7oBzDLI=")
ki5.loginResult()
...
wait = {
    ...
    "lang":"JP",
    "comment":"Auto Like by : Kakashi Ghost Rider",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
		...
		#    cl.sendText(msg.to,"Khusus Admin")
                ...
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        ...
                        ki2.sendText(msg.to,"Linkprotet set off")
                        ki3.sendText(msg.to,"Linkprotect off")
...
#-----------------------------------------------------------
                ...
                profile = ki3.getProfile()
                text = profile.displayName + " Ghosr Rider "
